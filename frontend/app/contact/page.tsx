      ...
      <div className="grid gap-10 lg:grid-cols-[0.85fr_1.15fr]">
        <div>
          ...
          <div className="mt-8 grid gap-3">
            <div className="rounded-[1.5rem] border border-white/70 bg-white/64 p-5 shadow-glass backdrop-blur">
            ...
            <div className="rounded-[1.5rem] bg-ink p-5 text-pearl shadow-glow">
              <Sparkles className="mb-4 h-5 w-5 text-blush" />
              <p className="font-black">Pitch line</p>
              <p className="mt-2 text-sm leading-6 text-pearl/64">“Osheen reduces doubt before purchase and turns catalogues into emotional styling rooms.”</p>
            </div>
          </div>
        </div>
        <ContactForm />
